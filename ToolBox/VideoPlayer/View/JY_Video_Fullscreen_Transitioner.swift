//
//  JY_Video_Fullscreen_Transitioner.swift
//  JY_Treasure_Box
//
...
public class JY_Video_Fullscreen_Transitioner: NSObject {
    
    public var playerView: JY_Video_Player_View?
    public var duration: TimeInterval = 0.25
    public var fullscreenControls: [UIView] = []
    public var fullscreenPlayerView: JY_Video_Fullscreen_Player_View?
...
extension JY_Video_Fullscreen_Transitioner: UIViewControllerTransitioningDelegate {
...
extension JY_Video_Fullscreen_Transitioner: UIViewControllerAnimatedTransitioning {
...
private extension JY_Video_Fullscreen_Transitioner {
