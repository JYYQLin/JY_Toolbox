...
open class JY_Video_Player_View: UIView {
      
    public enum JY_Player_State {
    ...
    public private(set) var state: JY_Player_State = .none {
    ...
    open var stateDidChanged: ((JY_Player_State) -> Void)?
...
@objc extension JY_Video_Player_View {
...
public extension JY_Video_Player_View {
...
private extension JY_Video_Player_View {
    ...
    func stateDidChanged(state: JY_Player_State, previous: JY_Player_State) {
...
extension JY_Video_Player_View.JY_Player_State: Equatable {
    
    public static func == (lhs: JY_Video_Player_View.JY_Player_State, rhs: JY_Video_Player_View.JY_Player_State) -> Bool {
        switch (lhs, rhs) {
        case (.none, .none):
            return true
